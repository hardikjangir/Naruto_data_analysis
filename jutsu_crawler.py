...
#         if soup.find('h2',{'id':'quiz_module_desktop_placement_styles'}):
#             soup.find('h2',{'id':'quiz_module_desktop_placement_styles'}).decompose()
        
#         if soup.find('a',{'id':'quiz_module_desktop_placement_styles'}):
#             soup.find('a',{'id':'quiz_module_desktop_placement_styles'}).decompose()
